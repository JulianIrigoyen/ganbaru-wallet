...
- [ ] Next step with be to implement persistence for the production environment with reactive mongo and [null-vector](https://github.com/null-vector/akka-reactivemongo-plugin)
